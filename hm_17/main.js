 ...
 */
function replaceHTMLComments(comments) {
  return comments.replace(/(<!--[а-я]+[0-9]-->|<!--\s+[а-яё]+[0-9]+\s-->)/g,'');
...
function checkDomainUrl(website) {
  return (/^(https?:\/\/)+([a-z0-9-]+\.)+([a-z]?)+([a-z]{2,3}?)$/).test(website);
...
function createLinksFromDomains(domain) {
  domain.replace(/https?:\/\/./+[a-z]/+/\./[a-z]{2,3}$/g/,<a href="http://site.ua">site.ua</a> text1);
...
/*text1 <a href="http://site.ua">site.ua</a> 
text2 <a href="https://site.com">site.com</a> 
text3 <a href="https://site.com.ua">site.com.ua</a> 
text4 <a href="https://subdomain.my-site.com.ua">subdomain.my-site.com.ua</a> 
*/